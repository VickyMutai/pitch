...
def setUp(self):
    ...
    self.new_pitch = Pitch(name='Victoria',
                           category='Interview',
                           pitch='Hello, I may not be the best but I wont be',
                           posted="17.06.1996 06.38",
                           user=self.user_vicky)
...
def test_check_instance_variables(self):
    ...
    self.assertEquals(self.new_pitch.posted,"17.06.1996 06.38")
...
def test_get_pitch_by_category(self):
    self.new_pitch.save_pitch()
    got_pitch = Pitch.get_pitch('Interview')
